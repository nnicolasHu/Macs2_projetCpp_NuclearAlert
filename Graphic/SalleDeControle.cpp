...
void SalleDeControle(sdl2::window& fenêtre, centrale& C){
    ...
    sdl2::texte val_barre_react_eff("valeur effective : "s + arrondi(C.get_Reacteur().get_Tx_graphite(), 0) + " %"s,fonte_texte, fenêtre, {0xAD, 0xFF, 0x2F, 0});
    val_barre_react_eff.at(430, 290);
    sdl2::texte val_barre_reacteur("valeur demandé : "s + arrondi(C.get_Reacteur().get_TGraphite_eff(), 0) + " %"s,fonte_texte, fenêtre, {0xAD, 0xFF, 0x2F, 0});
    ...
    sdl2::texte val_tx_bore_react_eff("valeur effective : "s + arrondi(C.get_Reacteur().get_Tx_bore(), 0) + " %"s,fonte_texte, fenêtre, {0xAD, 0xFF, 0x2F, 0});
    val_tx_bore_react_eff.at(430, 370);
    sdl2::texte val_tx_bore_react("valeur demandé : "s + arrondi(C.get_Reacteur().get_TBore_eff(), 0) + " %"s,fonte_texte, fenêtre, {0xAD, 0xFF, 0x2F, 0});
